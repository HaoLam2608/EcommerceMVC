...
namespace EcommerceHao.Controllers
{
    ...
    {
        private readonly HaoLamShopContext _context;

        public HangHoasController(HaoLamShopContext context)
        {
            _context = context;
        }
        ...
        {
            var haoLamShopContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await haoLamShopContext.ToListAsync());
        }

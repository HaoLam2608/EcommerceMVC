...
namespace EcommerceHao.Data;

public partial class HaoLamShopContext : DbContext
{
    public HaoLamShopContext()
    {
    }

    public HaoLamShopContext(DbContextOptions<HaoLamShopContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=MSI\\SQLEXPRESS;Initial Catalog=HaoLamShop;Integrated Security=True;Trust Server Certificate=True");
